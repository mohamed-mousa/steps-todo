<template>
  <svg id="f20e0c25-d928-42cc-98d1-13cc230663ea" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
    xmlns:xlink="http://www.w3.org/1999/xlink" width="160" height="140" viewBox="0 0 820.16 780.81">
    <defs>
    ...
    <path
      ...
      transform="translate(-189.92 -59.59)" fill="#fdb813" />
    ...
    <rect x="377.02" y="104.56" width="199.84" height="47.27" fill="#fdb813" />
    <path
